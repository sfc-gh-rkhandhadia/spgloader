...
from source_adapter import build_adapter as _build_source_adapter
...
def fetch_mssql_counts(mssql_host, mssql_port, mssql_user, mssql_password, mssql_db):
    """Query source DB for actual object counts by schema + type."""
    try:
        import os
        os.environ.setdefault('SOURCE_HOST', mssql_host or '')
        os.environ.setdefault('MSSQL_HOST',  mssql_host or '')
        os.environ.setdefault('SOURCE_PORT', str(mssql_port or 1433))
        os.environ.setdefault('MSSQL_PORT',  str(mssql_port or 1433))
        os.environ.setdefault('SOURCE_USER', mssql_user or '')
        os.environ.setdefault('MSSQL_USER',  mssql_user or '')
        os.environ.setdefault('SOURCE_PASSWORD', mssql_password or '')
        os.environ.setdefault('MSSQL_PASSWORD',  mssql_password or '')
        os.environ.setdefault('SOURCE_DATABASE', mssql_db or '')
        os.environ.setdefault('MSSQL_DATABASE',  mssql_db or '')
